              ...
              <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-gray-200/70 dark:border-gray-700/70 rounded-xl shadow-xl p-4 min-w-[240px] max-w-[280px]">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 rounded-lg px-3 py-3 bg-amber-50/50 dark:bg-amber-900/10 hover:bg-amber-100/80 dark:hover:bg-amber-900/20 transition group"
                  >
                    ...
                    <span className="text-sm font-medium text-amber-700 dark:text-amber-300">Support</span>
                  </button>
