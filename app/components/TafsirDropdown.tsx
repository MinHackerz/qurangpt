    ...
    <div className="mt-3">
      ...
      <div className="space-y-2">
        {isLoading ? (
          ...
          <button
            onClick={() => fetchTafsir()}
            className="w-full flex items-center justify-between px-3 py-2 bg-emerald-50 dark:bg-emerald-900/30 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 rounded-lg border border-emerald-200 dark:border-emerald-700 transition-colors duration-200"
          >
          ...
          tafsirData.tafsirs.map((tafsir, index) => (
            <div key={index} className="border border-emerald-200 dark:border-emerald-700 rounded-lg overflow-hidden">
              <button
                onClick={() => toggleTafsir(tafsir.author)}
                className="w-full flex items-center justify-between px-3 py-2 bg-emerald-50 dark:bg-emerald-900/30 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition-colors duration-200"
              >
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              ...
              <AnimatePresence>
                {expandedTafsir === tafsir.author && (
                  ...
                  >
                    <div className="px-4 py-3 bg-white dark:bg-gray-800 border-t border-emerald-200 dark:border-emerald-700">
